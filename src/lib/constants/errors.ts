...
const EXPIRED_LINK = errorHandlers.createErrorObject('Link has expired.', 401);
const UNAUTHORIZED = errorHandlers.createErrorObject('Unauthorized', 401);
...
export { MISSING_USER_OBJECT, EXPIRED_LINK, USER_EXISTS, USER_NOT_REGISTERED, INVALID_CREDENTIALS, NEWS_POST_EXISTS, SEQUELIZE_UNIQUE_CONSTRAINT, INVALID_REFRESH_TOKEN, UNAUTHORIZED }